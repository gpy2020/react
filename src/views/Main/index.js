  ...
  return (
    <Switch>
      <Route
        exact
        path="/react/counters"
        component={withRoot(ParentCounterContainer)}
      />
      <Route exact path="/react/about" component={withRoot(AboutContainer)} />
      <Route exact path="/react/" component={withRoot(HomeContainer)} />
      <Route
        exact
        path="/react/login-redux"
        component={withRoot(LoginReduxContainer)}
      />
      <Route exact path="/react/login" component={withRoot(LoginContainer)} />
      <Route
        exact
        path="/react/login-redux/success"
        component={withRoot(ReduxSuccessContainer)}
      />
      <Route
        exact
        path="/react/login-redux-form"
        component={withRoot(LoginReduxFormContainer)}
      />
      <Route
        exact
        path="/react/login-redux-form/success"
        component={withRoot(ReduxSuccessContainer)}
      />
